...
//collaudata
public abstract class Stat implements TreeComponent,ScriviCodice,AzioniSemanticheNodi{
		...
		public void startScoping(Env e) {
			...
			if(e.existFunction(id)){
				...
				if(!(e.getNumArgomenti(id+conta))){
					throw new IllegalArgumentException("Gli elementi inseriti sono minori rispetto alla definizione della funzione "+id);
				}
			}	
		}
	}
